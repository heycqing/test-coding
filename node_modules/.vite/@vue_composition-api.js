...
function warn$1(msg, vm) {
  vue_runtime_esm_default.util.warn(msg, vm);
}
...
try {
  requiredVue = (init_vue_runtime_esm(), vue_runtime_esm_exports);
...
function shallowReadonly(obj) {
  ...
  var _loop_1 = function(key2) {
    ...
    proxy(readonlyObj, key2, {
      ...
      set: function(v) {
        if (true) {
          warn$1('Set operation on key "' + key2 + '" failed: target is readonly.');
        }
      }
    });
  };
...
function set$1(target, key, val) {
  ...
  if (isUndef(target) || isPrimitive(target)) {
    warn2("Cannot set reactive property on undefined, null, or primitive value: " + target);
  }
...
function del(target, key) {
  ...
  if (isUndef(target) || isPrimitive(target)) {
    warn2("Cannot delete reactive property on undefined, null, or primitive value: " + target);
  }
...
var vue_composition_api_esm_default = Plugin;

// dep:@vue_composition-api
var vue_composition_api_default = vue_composition_api_esm_default;
export {
  EffectScope,
  computed,
  createApp,
